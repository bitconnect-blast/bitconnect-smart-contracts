...
import {IBlast} from "./blast/interfaces/IBlast.sol";
import {IBlastPoints} from "./blast/interfaces/IBlastPoints.sol";
...
contract BITCONNECT is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256 supplyToLiquidity = (totalSupply * 35) / 100;
    ...
    function addLiquidityAndStartTrading(uint256 _blocks)
        external
        payable
        onlyOwner
    {
    ...
    function manualswap(uint256 amount) external {
        require(
            ...
            "Only owner or marketing wallet"
        );
        require(
    ...
    function setBots(address[] calldata accounts, bool value) public onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
            if (
                ...
                (!_isExcludedFromFees[accounts[i]] &&
                    !_isExcludedMaxTransactionAmount[accounts[i]])
